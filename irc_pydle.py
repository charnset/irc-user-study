...
class MyOwnBot(pydle.Client):
    ...
    async def on_message(self, target, source, message):
        ...
        if source != self.nickname:
            ...
            actions, extractions = self._puppeteer.react([MessageObservation(message)], self._extractions)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--agenda_dir", type=str, help='path to agenda & data directory')
