...
class TestConversation:
    ...
    def say(self, text):
        ...
        actions, extractions = self._puppeteer.react(
            [MessageObservation(text)], self._extractions
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--nli_data_dir", type=str, help="path to NLI training data directory"
    )
    parser.add_argument(
        "--nlu_data_dir", type=str, help="path to NLU training data directory"
    )
